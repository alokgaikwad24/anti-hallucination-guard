---
name: fact-guard
description: Use any time work contains numbers, statistics, dates, quotes, sources, citations, or factual claims -- including quick lookups, not just formal documents like reports, market sizing, competitive analysis, stakeholder updates, stock/market prices, sports scores, exchange rates, current role-holders/company figures, population/geo stats, product specs, or other current/comparative figures. Trigger proactively, including for single quick-answer questions, whenever a request could tempt stating a number, statistic, citation, or fact not verified in-conversation (e.g. "market size", "current price", "today vs yesterday", "latest score", "according to X", "studies show", "as of [date]", or any current/comparative data not already provided or searched for). Enforces a claim-verification workflow so numbers/citations/facts are never fabricated -- labels every claim Verified, Estimated, or Unknown. Consult before finalizing any answer, however short, with quantitative claims, even if not explicitly requested.
---
