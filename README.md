...
**Claude.ai / Claude Apps:** Download the packaged `.skill` bundle from this repo's [Releases](../../releases) page and upload it via Settings → Capabilities → Skills.

**Claude Code / Cowork:** Clone or copy this repository into your skills directory (e.g. `~/.claude/skills/fact-guard/`), keeping the `SKILL.md` + `references/` structure intact.

**Manual packaging:** If you've edited the source and want a fresh `.skill` bundle, use Anthropic's [skill-creator packaging script](https://github.com/anthropics/skills) against this folder.
